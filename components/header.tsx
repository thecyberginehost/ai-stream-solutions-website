...
export default function Header() {
  ...
  const servicesLinks = [
    { href: "/services/local", label: "Local Business", icon: Users },
    { href: "/services/enterprise", label: "Enterprise", icon: Building2 },
  ]
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56">
                <DropdownMenuItem asChild>
                  <Link href="/services" className="flex items-center space-x-2 w-full">
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-lg">
            ...
            {/* Mobile Services Accordion-like section */}
            <div>
              <button
              ...
              >
                <span>Services</span>
                <ChevronDown className={cn("h-5 w-5 transition-transform", isServicesMenuOpen && "rotate-180")} />
              </button>
              {isServicesMenuOpen && (
